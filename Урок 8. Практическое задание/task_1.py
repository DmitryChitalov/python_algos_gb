...
"""
Решение из интернета, c использованием модуля heapq из стандартной библиотеки Python
Постарался разобраться с реализацией алгоритма очереди с кучей, отлично вписывается в реализацию кодировки 
строки "Хаффмана"
"""
