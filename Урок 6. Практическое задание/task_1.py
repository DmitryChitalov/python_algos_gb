...
# Возьму разные вариации своей программы из курса "Основ Python" и на примере работы с библиотечкой itertools и методом count
...
1. Существенного прироста памяти не произошло, согласно работе нашего профилировщика.
2. При разных запусках, усредненные значения (сделанно вручную) соответствуют преведенной статистике выше.
3. Оптимизация не требуется
"""
