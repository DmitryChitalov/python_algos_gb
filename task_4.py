...
# Вторая реализация будет лучше, т.к. в ней не используется цикл,
...
print('user1:', authorization2(my_users, 'user1', '11111'))
print('user2:', authorization2(my_users, 'user2', '1111'))
print('user4:', authorization2(my_users, 'user4', '11111'))
print('user5:', authorization2(my_users, 'user5', '1111'))
