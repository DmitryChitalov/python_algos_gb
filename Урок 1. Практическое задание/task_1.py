...
def check_1(lst_obj):
    ...
    Сложность:
    T(n) = O(len(lst_obj)) количество элементов рандомно.Мы можем его регулировать
    """
...
def check_2(lst_obj):
    ...
    Сложность:
    работа ведется со списком значений.
    T(n) = O(N)
    """
...
def check_3(lst_obj):
    ...
    n log n
    """
    lst_copy = list(lst_obj)                 # O(len(lst_obj))- количество элементов (рандомно).Мы можем его регулировать
