...
def check_1(lst_obj):
    ...
    Сложность: !!!. O(len(...)) = O(n)
    """
    lst_to_set = set(lst_obj)  # !!! O(len(...)) - зависит от длины аргумента, говорят это O(n)
...
def check_2(lst_obj):
    ...
    Сложность: !!!. O(n^2)
    """
    for j in range(len(lst_obj)):          # !!! O(n) +O(n) вложенный срез = O(n^2)
...
def check_3(lst_obj):
    ...
    Сложность: !!! O(n log n)
    """
    lst_copy = list(lst_obj)                 # !!! O(len(...)) - зависит от длины аргумента, говорят это O(n)
    lst_copy.sort()                          # !!! O(n log n)
    for i in range(len(lst_obj) - 1):        # !!! O(n) +O(1) вложенное сравнение = O(n)
