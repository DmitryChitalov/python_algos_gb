...
def check_1(lst_obj):
    ...
    return lst_to_set          # 1. Итоговая сложность T(n) = 1
...
def check_2(lst_obj):
    ...
    for j in range(len(lst_obj)):          # n
        if lst_obj[j] in lst_obj[j+1:]:    # log n
            return False                   # 1
    return True                            # 1. Итоговая сложность T(n) = n
...
def check_3(lst_obj):
    ...
    for i in range(len(lst_obj) - 1):        # n
        if lst_copy[i] == lst_copy[i+1]:     # n
            return False                     # 1
    return True                              # 1. Итоговая сложность T(n) = n log n.
