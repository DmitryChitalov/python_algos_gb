...
"""
Самым эффективным вариантом является вариант с использованием среза, так как он имеет сложность О(n), и это встроенный
механизм.
...
"""
#  для сравнения результатов работы timeit и repeat
setup = """
