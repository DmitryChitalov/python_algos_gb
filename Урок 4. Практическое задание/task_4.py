...
def func_3():
    ...
    return f'Чаще всего встречается число {el}, оно появилось в массиве {array.count(el)} раз(а) '
...
#Дольше всего работает func_2, т.к для каждого числа из массива функция считает колличество включений.