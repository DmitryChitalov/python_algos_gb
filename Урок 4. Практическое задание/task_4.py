...
Дополнительно затрачиваем время и память на создание массива с количеством вхождений каждого элемента.
...
элементов из множества, где исключены дубли. Задачу удалось ускорить.
4. Четвертый вариант сопоставим с первым. Используем две встроенные функции с O(n) каждая.
"""
