...
"""
2 попытаемся оптимизировать код. Преобразуем число к строке и воспользуемся извлечением среза.
"""
print(str(num_100)[::-1])
...
Как видим реверс строки методом извлечения среза значительно эффективнее рекурсии.
