...
"""
Оптимизация ускорила время выполнения в несколько раз. Заметно это станет при обработке больших массивов.
Замеры функции без доработки:
0.0060652
Замеры функции после доработки:
0.0010644999999999995
"""
