...
"""
    В целом: оптимизация не дала большого эфекта уже даже на этапе, когда я просто начал делать обратную сортировку. После того как
    я добавил проверку "была ли сортировка в проходе" - количество вхождений уменьшелось на некоторых прогонах
