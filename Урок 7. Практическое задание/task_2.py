...
Исходный - [46.11436617832828, 41.62921998361278,
            18.45859540989644, 12.128870723745806, 8.025098788570562]
...
orig_list = [random.uniform(0, 50) for _ in range(x)]

print(f'start {len(orig_list)}:', orig_list)
print(timeit.timeit("merge_sort(orig_list)", setup="from __main__ import merge_sort, orig_list", number=1))
print(f'finish {len(orig_list)}:', orig_list)
